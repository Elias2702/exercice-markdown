...
2. Ajouter le nom du langage dans lequel vous allez rédiger votre code
3. Passer à la ligne
4. Inscrire le code à afficher
5. Fermer avec trois accents grave

Note : Bien que cela fonctionne sans, la mise en commentaire avec le langage est la syntaxe correcte !
...
Si d'aventure il vous prennait l'envie d'ajouter des emojis dans vos documents, il suffit d'inscrire la commande correspondante :
...
Pour obtenir la liste complète des emojis disponnibles sur gitHub, c'est [**par ici**](https://gist.github.com/rxaviers/7360908)!
